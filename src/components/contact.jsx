        ...
        <div className="container-fluid d-flex bg-primary">
            <div className="container d-flex justify-content-center">
                <ul className="d-flex flex-row align-items-center text-center list-unstyled text-white gap-5">
                    ...
                    <li><img width="40" src="./public/img/buy-comics-shop-locator.png" alt="" />comic shop locator</li>
                    <li><div className="d-flex align-items-center"><img width="90" src="./public/img/buy-dc-power-visa.svg" alt="" />dc power visa</div></li>
                </ul>
            </div>
        </div>
    )
